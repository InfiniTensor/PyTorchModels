...
def parse_args():
    ...
    parser.add_argument('--ckpdir',type=str,default='./checkpoints',metavar='DIR',
                        help='Where to save ckps')
    parser.add_argument('--cachedir',type=str,default='./data',metavar='DIR',
                        help='Where to save cached data')
...
def main():
    ...
    if args.do_train:
        ...
        if args.distributed:
            ...
            cache_file_prefix = args.cachedir
        ...
        for epoch in range(args.start_epoch, args.epochs):
            ...
            metric_collector.insert_metrics(
                ...
                cards = args.ndevices if args.local_rank == 0 else 1,
