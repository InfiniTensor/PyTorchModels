...
class ModelArguments:
    ...
    online: bool = field(
        default=False,
        metadata={"help": "Whether to use local offline model file or downloading from huggingface.co/models"}
    )
...
def main():
    ...
    if training_args.do_train:
        ...
        elif model_args.online and os.path.isdir(model_args.model_name_or_path):
